...
#
import sys
from RIO.csvdb.test_rio.rio_database import DataMapper # superclass of generated classes

_Module = sys.modules[__name__]  # get ref to our own module object

class BlendCapitalCost(DataMapper):
    _instances_by_key = {}
...
class BlendExistingStorage(DataMapper):
    _instances_by_key = {}
...
class BlendExoDemand(DataMapper):
    _instances_by_key = {}
...
class BlendFuelInputs(DataMapper):
    _instances_by_key = {}
...
class ConversionCapitalCost(DataMapper):
    _instances_by_key = {}
...
class ConversionEfficiency(DataMapper):
    _instances_by_key = {}
...
class ConversionFixedOmAnn(DataMapper):
    _instances_by_key = {}
...
class ConversionMain(DataMapper):
    _instances_by_key = {}
...
class ConversionRps(DataMapper):
    _instances_by_key = {}
...
class ConversionVariableOm(DataMapper):
    _instances_by_key = {}
...
class ProductEmissions(DataMapper):
    _instances_by_key = {}
...
class ProductPotential(DataMapper):
    _instances_by_key = {}
...
class TechCapacityFactor(DataMapper):
    ...
    _key_col = "name"
    _cols = ["extrapolation_method", "geography", "geography_map_key", "interpolation_method", "name",
             "notes", "source"]
    _df_cols = ["vintage", "gau", "value", "sensitivity"]
    _df_key_col = "None"
    _data_table_name = None
...
class TechCurtailmentCost(DataMapper):
    _instances_by_key = {}
...
class TechEfficiency(DataMapper):
    _instances_by_key = {}
...
class TechPotential(DataMapper):
    _instances_by_key = {}
...
class TechRetirementCost(DataMapper):
    _instances_by_key = {}
...
class TechShutdownCost(DataMapper):
    _instances_by_key = {}
...
class TechVariableOm(DataMapper):
    _instances_by_key = {}
